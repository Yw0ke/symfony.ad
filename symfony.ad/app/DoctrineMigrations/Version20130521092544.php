...
class Version20130521092544 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE Ads (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(80) NOT NULL, owner_type VARCHAR(42) NOT NULL, owner_adress VARCHAR(255) NOT NULL, owner_city VARCHAR(42) NOT NULL, owner_zip INT NOT NULL, owner_country VARCHAR(42) NOT NULL, owner_phone INT NOT NULL, comment LONGTEXT NOT NULL, boat_id INT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
